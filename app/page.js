...
export default function Home() {
  ...
  return <main id="top">
    ...
    <section className="whyChoose section" aria-labelledby="why-choose-title">
      ...
      <div className="whyVisual"><img src="/personal-attention-consultation.png" alt="Attorney meeting with a client in a modern San Diego office"/><div className="whyNote"><strong>Your case deserves</strong><span>careful attention from day one.</span></div></div>
    </section>
